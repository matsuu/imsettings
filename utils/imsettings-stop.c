     ...
     char **argv)
{
	...
	GOptionEntry entries[] = {
		{"force", 'f', G_OPTION_FLAG_NO_ARG, G_OPTION_ARG_NONE, &arg_force, N_("Force stopping the IM process regardless of any errors."), NULL},
  ...
  retry2:
	...
	if (imsettings_request_stop_im(req_settings, module, !arg_no_update, arg_force, &error)) {
		g_print(_("Stopped %s\n"), module);
	} else {
